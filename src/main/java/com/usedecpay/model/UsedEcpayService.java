...
public class UsedEcpayService {
	...
	public static String genAioCheckOutOneTime(String usedNo,
		...
		obj.setReturnURL("https://e233-111-243-143-5.ngrok-free.app/used/ecpay/notify");// 接收綠界收款回覆的controller網址，controller做完資料分析及資料儲存後，回覆1|OK給綠界
//		obj.setOrderResultURL("http://localhost:8080/used/select_page");
		obj.setNeedExtraPaidInfo("N");
		obj.setRedeem("N");
		obj.setClientBackURL("https://e233-111-243-143-5.ngrok-free.app/member");// 設定付款完成後消費者要看到的網頁(轉網址)
