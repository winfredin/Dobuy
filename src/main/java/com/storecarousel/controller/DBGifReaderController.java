...
public class DBGifReaderController {
    ...
    public void gifReader(@RequestParam("storeCarouselNo") String storeCarouselNo, HttpServletRequest req, HttpServletResponse res) throws IOException {
        res.setContentType("image/gif");
        ServletOutputStream out = res.getOutputStream();

        try {
            out.write(storeCarouselService.getOneStoreCarousel(Integer.valueOf(storeCarouselNo)).getCarouselPic());
        } catch (Exception e) {
